...
window.addEventListener("DOMContentLoaded", startTyping);
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                animateCounter(document.getElementById('clients-count'), 10);
    ...
    // Political Testimonials Carousel (Niche Aligned)
const testimonials = [
  {
    text: "Infogrip helped structure my social media presence professionally. The messaging became consistent and the overall perception improved significantly.",
    author: "Independent Political Leader",
    role: "Municipal Level, Rajasthan"
  },
  {
    text: "Their digital team understands political communication. Content planning, posting discipline, and outreach execution were handled smoothly.",
    author: "Youth Wing Representative",
    role: "State Political Organization"
  },
  {
    text: "We used Infogrip during the election phase for digital outreach. The execution was timely, organized, and aligned with campaign needs.",
    author: "Election Campaign Coordinator",
    role: "Assembly Constituency"
  },
  {
    text: "Infogrip brought clarity to online communication. The digital branding work helped maintain a serious and professional public image.",
    author: "Senior Political Leader",
    role: "Regional Level, North India"
  },
  {
    text: "The team worked as a neutral digital execution partner. Communication was clear and delivery stayed on schedule throughout.",
    author: "Political Strategy Team Member",
    role: "Campaign Operations"
  },
  {
    text: "Their structured approach to social media and digital ads helped improve visibility without unnecessary noise.",
    author: "Political Office Representative",
  ...
  // Political-Focused Features Carousel (SEO Optimized)
const featuresData = [
  {
    icon: "fas fa-bullseye",
    title: "Political-First Digital Execution",
    description: "All our systems, content, and campaigns are designed exclusively for political leaders and elections."
  },
  {
    icon: "fas fa-chart-line",
    title: "Data-Driven Campaign Decisions",
    description: "We use performance data and audience insights to refine messaging and improve voter reach."
  },
  {
    icon: "fas fa-network-wired",
    title: "Structured Digital Frameworks",
    description: "Clear frameworks for social media, branding, and outreach—no random posting or guesswork."
  },
  {
    icon: "fas fa-bolt",
    title: "Fast & Reliable Execution",
    description: "Time-sensitive digital execution built for active political timelines and election phases."
  },
  {
    icon: "fas fa-comments",
    title: "Clear Political Communication",
    description: "Consistent digital messaging that strengthens public image and voter trust."
  },
  {
    icon: "fas fa-shield-alt",
    title: "Neutral & Professional Approach",
    description: "We work as a technology and execution partner—without political bias or party alignment."
  }
];
