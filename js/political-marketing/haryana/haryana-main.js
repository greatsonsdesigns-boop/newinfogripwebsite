document.addEventListener('DOMContentLoaded', function() {
            // Auto-typing effect for Haryana hero section
            const autoTypeElement = document.getElementById('auto-type');
            const phrases = [
                "Strategic Haryana Campaigns",
                "Strong Leadership Branding",
                "Haryana Political Visibility",
                "Regional Election Success",
                "Haryana-Specific Strategies"
            ];
            let phraseIndex = 0;
            let charIndex = 0;
            ...
            const citiesData = [
                {
                    ...
                    href: "gurugram/",
                    description: "Urban strategies for corporate and residential voter segments"
                },
                {
                    name: "Faridabad",
                    hindiName: "फरीदाबाद",
                    ...
                    href: "faridabad/",
                    description: "Industrial hub strategies with focus on working class voters"
                },
                {
                    name: "Rohtak",
                    hindiName: "रोहतक",
                    ...
                    href: "rohtak/",
                    description: "Educational and cultural center with traditional voter base"
                },
                {
                    name: "Sonipat",
                    hindiName: "सोनीपत",
                    icon: "fas fa-tractor",
                    href: "sonipat/",
                    description: "Agricultural region strategies for rural voter outreach"
                },
                {
                    name: "Hisar",
                    hindiName: "हिसार",
                    ...
                    href: "hisar/",
                    description: "Agricultural heartland strategies with focus on farming communities"
                },
                {
                    name: "Karnal",
                    hindiName: "करनाल",
                    ...
                    href: "karnal/",
                    description: "Basmati belt strategies for agricultural voter engagement"
                }
            ];
            ...
            // Calculate function for Haryana
            function updateCalculator() {
                ...
                // Region multipliers for Haryana
                const multipliers = {
                    'gurugram': 1.7,
                    'faridabad': 1.5,
                    'rohtak': 1.4,
                ...
                // Calculate estimated reach for Haryana
                const estimated = Math.round((budget * duration * baseMultiplier) / 7);
                
                // Calculate engagement rate for Haryana (10-15% range)
                const engagement = (10 + Math.random() * 5).toFixed(1);
                
                // Calculate cost per voter for Haryana (₹1.5-2.5 range)
            ...
            calculateBtn.addEventListener('click', function() {
                ...
                this.innerHTML = '<i class="fas fa-check"></i> Haryana Strategy Calculated!';
            ...
            // Bottom Hindi Popup for Haryana
