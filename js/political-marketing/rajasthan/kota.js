document.addEventListener('DOMContentLoaded', function() {
        // Auto-typing effect for Kota hero section
        const autoTypeElement = document.getElementById('auto-type');
        if (autoTypeElement) {
            const phrases = [
                "Strategic Kota Campaigns",
                "Youth-Focused Political Marketing",
                "Kota Political Branding",
                "Education Hub Strategies",
                "Kota-Specific Approaches"
            ];
            let phraseIndex = 0;
            let charIndex = 0;
