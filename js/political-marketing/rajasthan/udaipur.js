document.addEventListener('DOMContentLoaded', function() {
        // Auto-typing effect for Udaipur hero section
        const autoTypeElement = document.getElementById('auto-type');
        if (autoTypeElement) {
            const phrases = [
                "Strategic Udaipur Campaigns",
                "Cultural Voter Engagement",
                "Udaipur Political Branding",
                "Mewar Region Strategies",
                "Udaipur-Focused Approaches"
            ];
            let phraseIndex = 0;
            let charIndex = 0;
        ...
        // Bottom Hindi Popup for Udaipur
