document.addEventListener('DOMContentLoaded', function() {
        // Auto-typing effect for Ajmer hero section
        const autoTypeElement = document.getElementById('auto-type');
        if (autoTypeElement) {
            const phrases = [
                "Strategic Ajmer Campaigns",
                "Local Voter Outreach in Ajmer",
                "Ajmer Political Branding",
                "Community-Driven Communication",
                "Ajmer-Specific Strategies"
            ];
            let phraseIndex = 0;
            let charIndex = 0;
