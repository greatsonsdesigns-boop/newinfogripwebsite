document.addEventListener('DOMContentLoaded', function() {
        // Auto-typing effect for Jodhpur hero section
        const autoTypeElement = document.getElementById('auto-type');
        if (autoTypeElement) {
            const phrases = [
                "Strategic Jodhpur Campaigns",
                "Regional Leadership Building",
                "Jodhpur Political Branding",
                "Marwar Region Strategies",
                "Jodhpur-Specific Approaches"
            ];
            let phraseIndex = 0;
            let charIndex = 0;
        ...
        // Bottom Hindi Popup for Jodhpur
