    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Auto-typing effect for Jaipur hero section
        const autoTypeElement = document.getElementById('auto-type');
        if (autoTypeElement) {
            const phrases = [
                "Strategic Jaipur Campaigns",
                "Urban Voter Outreach in Jaipur",
                "Jaipur Political Branding",
                "Digital Leadership Building",
                "Jaipur-Specific Strategies"
            ];
            let phraseIndex = 0;
            let charIndex = 0;
