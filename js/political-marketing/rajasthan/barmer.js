document.addEventListener('DOMContentLoaded', function() {
        // Auto-typing effect for Barmer hero section
        const autoTypeElement = document.getElementById('auto-type');
        if (autoTypeElement) {
            const phrases = [
                "Strategic Barmer Campaigns",
                "Ground-Level Voter Outreach",
                "Barmer Political Branding",
                "Desert Region Strategies",
                "Barmer-Specific Approaches"
            ];
            let phraseIndex = 0;
            let charIndex = 0;
