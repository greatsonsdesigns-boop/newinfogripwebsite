...
document.addEventListener('DOMContentLoaded', function() {
    // Auto-typing effect for Bihar hero section
    const autoTypeElement = document.getElementById('auto-type');
    const phrases = [
        "Strategic Bihar Campaigns",
        "Local Voter Outreach",
        "Bihar Political Branding",
        "Regional Election Success",
        "Bihar-Specific Strategies"
    ];
    let phraseIndex = 0;
    let charIndex = 0;
    ...
    // Bihar Cities Carousel
    const citiesData = [
        {
            name: "Patna",
            hindiName: "पटना",
            icon: "fas fa-landmark",
            href: "political-marketing-in-patna.html",
            description: "Capital city strategies for urban and suburban voter segments"
        },
        {
            name: "Gaya",
            hindiName: "गया",
            icon: "fas fa-pray",
            href: "political-marketing-in-gaya.html",
            description: "Religious and cultural center with traditional voter demographics"
        },
        {
            name: "Muzaffarpur",
            hindiName: "मुजफ्फरपुर",
            icon: "fas fa-seedling",
            href: "political-marketing-in-muzaffarpur.html",
            description: "Agricultural region strategies for rural voter engagement"
        },
        {
            name: "Bhagalpur",
            hindiName: "भागलपुर",
            icon: "fas fa-industry",
            href: "political-marketing-in-bhagalpur.html",
            description: "Industrial and educational hub strategies for diverse communities"
        },
        {
            name: "Darbhanga",
            hindiName: "दरभंगा",
            icon: "fas fa-university",
            href: "political-marketing-in-darbhanga.html",
            description: "Cultural and educational center strategies for Mithila region"
        },
        {
            name: "Purnia",
            hindiName: "पूर्णिया",
            icon: "fas fa-border-all",
            href: "political-marketing-in-purnia.html",
            description: "Border region strategies for Seemanchal area political dynamics"
        }
    ];
    ...
    function updateCalculator() {
        ...
        // Calculate estimated reach for Bihar
        const estimated = Math.round((budget * duration * baseMultiplier) / 8);
        
        // Calculate engagement rate for Bihar (9-14% range)
        const engagement = (9 + Math.random() * 5).toFixed(1);
        
        // Calculate cost per voter for Bihar (₹2-3 range)
    ...
    calculateBtn.addEventListener('click', function() {
        ...
        this.innerHTML = '<i class="fas fa-check"></i> Bihar Strategy Calculated!';
